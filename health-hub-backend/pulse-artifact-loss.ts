...
const MANIFEST: Record<string, Field[]> = {
  breakdown: [
    ...
    D('shareOfTotal', 'material', (e) => has(e.summary?.total) || has(e.data?.total), false, 'arithmetic over value+total'),
    F('period',       'material', (e) => has(e.period) || has(e.summary?.period), false),
    F('rowsHidden',   'material', (e) => rows(e).length > 8, false, 'slice(0,8) with no remainder'),
    F('scope',        'material', (e) => has(e.summary?.scope), false),
  ...
  ranking: [
    ...
    F('label',        'material', (e) => rows(e).length > 0, true),
    F('value',        'material', (e) => rows(e).length > 0, true),
    F('total',        'material', (e) => has(e.summary?.total) || has(e.data?.total), false),
    D('shareOfTotal', 'material', (e) => has(e.summary?.total) || has(e.data?.total), false),
    F('period',       'material', (e) => has(e.period) || has(e.summary?.period), false),
    F('rowsHidden',   'material', (e) => rows(e).length > 8, false),
    D('concentration','material', (e) => rows(e).length > 4, false, 'top-N share, arithmetic'),
    F('change',       'useful',   (e) => anyRow(e, /change|delta/i), false),
    F('scope',        'useful',   (e) => has(e.summary?.scope), false),
    F('unit',         'useful',   (e) => has(e.unit), false),
    F('means',        'useful',   (e) => has(e.means), false),
  ],
  chart: [
  ...
  table: [
    ...
    F('rowsHidden',   'material', (e) => rows(e).length > 15, false),
    F('period',       'material', (e) => has(e.period) || has(e.summary?.period), false),
  ...
  waterfall: [
    ...
    F('startEnd',     'material', (e) => has(e.data?.total) || has(e.summary?.total), false, 'only the net is shown'),
