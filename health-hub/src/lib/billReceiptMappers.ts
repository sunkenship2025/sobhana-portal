...
export function mapApiBillToReceiptData(api: ApiBillData): BillReceiptData {
  return {
    ...
    couponDiscountInPaise: (api.visit as any).couponDiscountInPaise,
    couponCode: (api.visit as any).couponCode,
...
export function mapClinicVisitViewToReceiptData(
  ...
  return {
    ...
    couponDiscountInPaise: (visit as any).couponDiscountInPaise,
    couponCode: (visit as any).couponCode,
...
export function mapDiagnosticsVisitViewToReceiptData(
  ...
  return {
    ...
    couponDiscountInPaise: (visitView.visit as any).couponDiscountInPaise,
    couponCode: (visitView.visit as any).couponCode,
